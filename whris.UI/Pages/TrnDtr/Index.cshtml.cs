...
namespace whris.UI.Pages.TrnDtr
{
    ...
    public class IndexModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostReadDtrList([DataSourceRequest] DataSourceRequest request, int payrollGroupId)
        {
            var allDtrs = new GetTrnDtrsByPayrollGroupId()
            {
                Request = request,
