...
namespace whris.UI.Pages.TrnLastWithholdingTax
{
    ...
    public class IndexModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostReadLWTList([DataSourceRequest] DataSourceRequest request, int payrollGroupId)
        {
            var allDtrs = new GetTrnLastWithholdingTaxesByPayrollGroupId()
            {
                Request = request,
