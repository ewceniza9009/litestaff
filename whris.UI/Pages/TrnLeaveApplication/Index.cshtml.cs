...
namespace whris.UI.Pages.TrnLeaveApplication
{
    ...
    public class IndexModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostReadLAList([DataSourceRequest] DataSourceRequest request, int payrollGroupId)
        {
            var allDtrs = new GetTrnLeaveApplicationsByPayrollGroupId()
            {
                Request = request,
